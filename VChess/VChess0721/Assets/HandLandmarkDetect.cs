...
namespace TensorFlowLite
{
    public class HandLandmarkDetect : BaseImagePredictor<float>
    {
        ...
        // keypoint: each key point has two float coordinates: x and y
        // wrist,
        ...
        public readonly float[] output0 = new float[JOINT_COUNT * 2]; 
        // hand flag: 0 or 1; right or left
        public readonly float[] output1 = new float[1]; // hand flag
        ...
        {
            // required to have palmDetect.Invoke called before to have a more accurate result
            throw new System.NotImplementedException();
        }

        public void Invoke(Texture inputTex, PalmDetect.Result palm)
        {
            // transform the detected palm
            ...
            // call tflite model interpreter to execute the model
