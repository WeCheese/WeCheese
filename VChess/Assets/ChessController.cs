...
public class ChessController : MonoBehaviour
{
    ...
    public void init(bool player_)
    {
        player = player_;
        turn = player_;
        Debug.Log("chess controller init: before register");
    ...
    public void Start()
    {
        chessDict = new Dictionary<ChessID, Chess> {
            ...
            // Other Player
            // King
            { new ChessID(false, 0), new King(new ChessID(false, 0), transformPos(new Vector2Int(4, 0)))},
            // Guard
            { new ChessID(false, 1), new Guard(new ChessID(false, 1), transformPos(new Vector2Int(3, 0)))},
            { new ChessID(false, 2), new Guard(new ChessID(false, 2), transformPos(new Vector2Int(5, 0)))},
            // Bishop
            { new ChessID(false, 3), new Bishop(new ChessID(false, 3), transformPos(new Vector2Int(2, 0)))},
            { new ChessID(false, 4), new Bishop(new ChessID(false, 4), transformPos(new Vector2Int(6, 0)))},
            // Knight
            { new ChessID(false, 5), new Knight(new ChessID(false, 5), transformPos(new Vector2Int(1, 0)))},
            { new ChessID(false, 6), new Knight(new ChessID(false, 6), transformPos(new Vector2Int(7, 0)))},
            // Cannon
            { new ChessID(false, 7), new Cannon(new ChessID(false, 7), transformPos(new Vector2Int(1, 2)))},
            { new ChessID(false, 8), new Cannon(new ChessID(false, 8), transformPos(new Vector2Int(7, 2)))},
            // Rook
            { new ChessID(false, 9), new Rook(new ChessID(false, 9), transformPos(new Vector2Int(0, 0)))},
            { new ChessID(false, 10), new Rook(new ChessID(false, 10), transformPos(new Vector2Int(8, 0)))},
            // Pawn
            { new ChessID(false, 11), new Pawn(new ChessID(false, 11), transformPos(new Vector2Int(0, 3)))},
            { new ChessID(false, 12), new Pawn(new ChessID(false, 12), transformPos(new Vector2Int(2, 3)))},
            { new ChessID(false, 13), new Pawn(new ChessID(false, 13), transformPos(new Vector2Int(4, 3)))},
            { new ChessID(false, 14), new Pawn(new ChessID(false, 14), transformPos(new Vector2Int(6, 3)))},
            { new ChessID(false, 15), new Pawn(new ChessID(false, 15), transformPos(new Vector2Int(8, 3)))},
        };
        // Player 1
        // King
